                ...
                <div class="flex flex-col items-center gap-y-8 basis-3/5 px-28">
                    ...
                    <div>
                        <form action="{{ route('result') }}" method="POST"
                            ...
                            <p class="text-3xl text-white">Documento Nacional de Identidad</p>

                            <input type="number" name="dni" id="" value="{{ old('dni') }}"
                                class="rounded-lg px-8 py-2 text-center" required>

                            @error('dni')
                                <div class="bg-red-100 text-red-700 font-bold px-16 py-1 rounded-lg">{{ $message }}</div>
                            @enderror
